...
📸 Просто сфотографируй свою еду или опиши её словами, и я мгновенно посчитаю калории! 

🚀 Как это работает:

1️⃣ Сделай фото своего блюда или опиши его текстом или всей трапезы (или выбери фото из галереи). 
