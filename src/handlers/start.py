...
4. Возможность изменить время окончания дня (например если вы любите засиживаться до поздна) и дневную норму каллорий.
...
1. Статус за день - Получить статистику по каллориям и БЖУ за день
