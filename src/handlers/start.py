...
async def start(message: Message):
    try:
        ...
        if user is None:
            await register_user(message, balance=2)
        text = """
Привет! Добро пожаловать в @EasyCalloriesBot! 🤖 
Хочешь легко следить за своим питанием? 💪 Я помогу тебе!
 
📸 Просто сфотографируй свою еду, и я мгновенно посчитаю калории! 
 
🚀 Как это работает:
 
1️⃣ Сделай фото своего блюда или всей трапезы (или выбери фото из галереи). 
2️⃣ Умный бот проанализирует фото и выдаст точный расчет калорий и питательных веществ! 📊
 
⚡ Дополнительные фишки:
 
1️⃣ Отслеживай свой рацион в течение дня. 
2️⃣ Получай персонализированные рекомендации по питанию. 
3️⃣ Просматривай ежедневную аналитику и получай советы на будущее. 
4️⃣ Настраивай время окончания дня и дневную норму калорий под себя.

❗Чтобы я рассказал тебе о составе блюда, на твоем балансе в боте должны быть Telegram Stars. Раз уж ты зашел, я дарю тебе 2 ⭐️! Начни изучать свой рацион уже сегодня! 😉
...
Сделай фото своего блюда (или выбери из галереи) 📸 
Отправь его прямо в чат боту. 
Вуаля! EasyCaloriesBot мгновенно определит калорийность и состав твоей еды.
...
Пополнить счет: Заряжай свой аккаунт, чтобы продолжать пользоваться всеми возможностями бота. 💰
